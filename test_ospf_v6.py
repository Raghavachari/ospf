...
class OSPF_IPv6_ConfigSuite(unittest.TestCase):
    ...
    def test_add_ospf_conf_v6(self):
        ...
        out=commands.getoutput("heat --os-username " + OS_USERNAME + " --os-password " + OS_PASSWORD + " --os-tenant-name " + OS_TENANT_NAME + " --os-auth-url " + OS_AUTH_URL + " stack-create -f " + input_file[0] + " -P 'area_id=" + Area_ID_v6 + ";grid_members=" + Members + ";is_ipv4=False' ospf_conf_v6")
        time.sleep(10)
        logging.info(out)
    ...
    def test_add_anycast_loopback_ipv6_with_ospf(self):
        ...
        time.sleep(10)
        out=commands.getoutput("heat --os-username " + OS_USERNAME + " --os-password " + OS_PASSWORD + " --os-tenant-name " + OS_TENANT_NAME + " --os-auth-url " + OS_AUTH_URL + " stack-create -f " + input_file[0] + " -P 'ip=2020::20;enable_ospf=true;grid_members=" + Members + "' anycast")
        time.sleep(10)
        logging.info(out)
    ...
    def test_update_anycast_loopback_ipv6_address(self):
        ...
        input_file = glob.glob("anycast-loopback.yaml")
        out=commands.getoutput("heat --os-username " + OS_USERNAME + " --os-password " + OS_PASSWORD + " --os-tenant-name " + OS_TENANT_NAME + " --os-auth-url " + OS_AUTH_URL + " stack-update -f " + input_file[0] + " -P 'ip=2010::10;enable_ospf=false;grid_members=" + Members + "' anycast")
        time.sleep(10)
        logging.info(out)
    ...
    def test_update_ospf_ipv6_config(self):
        logging.info("Update OSPF Configuration using heat")
        commands.getoutput("sed -i -r 's/[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}/" + GRID_VIP + "/' ospf-settings.yaml")
        input_file = glob.glob("ospf-settings.yaml")
        out=commands.getoutput("heat --os-username " + OS_USERNAME + " --os-password " + OS_PASSWORD + " --os-tenant-name " + OS_TENANT_NAME + " --os-auth-url " + OS_AUTH_URL + " stack-update -f " + input_file[0] + " -P 'area_id=3.3.3.3;grid_members=" + Members + ";is_ipv4=False' ospf_conf_v6")
        time.sleep(10)
        logging.info(out)
    ...
    def test_delete_ospf_ipv6_config(self):
        ...
        out=commands.getoutput("heat --os-username " + OS_USERNAME + " --os-password " + OS_PASSWORD + " --os-tenant-name " + OS_TENANT_NAME + " --os-auth-url " + OS_AUTH_URL + " stack-delete ospf_conf_v6")
        time.sleep(10)
        logging.info(out)
